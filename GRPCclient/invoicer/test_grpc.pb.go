...
const (
	Adder_Add_FullMethodName = "/testGrpc.Adder/Add"
)
...
func (c *adderClient) Add(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error) {
...
func (UnimplementedAdderServer) Add(context.Context, *HelloRequest) (*HelloResponse, error) {
...
func _Adder_Add_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdderServer).Add(ctx, req.(*HelloRequest))
	}
